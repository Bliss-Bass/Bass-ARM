...
# Insert the export variable in build-rpi4.sh
sed -i '/# autogenerated clear exports go here/a export '"$variable_name"'=false' build-rpi4.sh

# Update the displayHelp() function
sed -i '/# autogenerated help items go here/a \ \ \ \ echo "--'"$command"'          '"$description"'"' build-rpi4.sh

# Update the build script options
sed -i '/# autogenerated menu items go here/a \ \ \ \ \ \ \ \ --'"$command"')\n\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ '"$variable_name"'=true\n\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ shift\n\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ;;' build-rpi4.sh

# Update the exports
sed -i '/# autogenerated export items go here/a export '"$variable_name"'=${'"$variable_name"':-false};' build-rpi4.sh
...
sed -i '/# autogenerated echo items go here/a echo "'"$formatted_desc_camel"': ${'"$variable_name"'}";' build-rpi4.sh
